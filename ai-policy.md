...
AI usage is OK for these use cases:
- Understanding a codebase, debugging, and research
- Automating a repetitive task
- AI code review (e.g., requesting a review from Copilot)

> [!NOTE]
> AI code review should not replace human code review, which we still require.

> [!WARNING]
> Please don't fully vibe code PRs. Submitting a PR that only AI understands is not only inconsiderate of the reviewer's time, but also detrimental to the maintainability of the project.
